...
test('calcula el intervalo completo de un mes aunque cambie el horario de verano', () => {
  assert.deepEqual(getOperationalMonthRangeIso(madridAtFour, '2026-10'), {
    startIso: '2026-10-01T02:00:00.000Z',
