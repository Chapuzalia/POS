...
create table if not exists public.venues (
  ...
  legal_name text check (legal_name is null or char_length(legal_name) <= 80),
  tax_id text check (tax_id is null or char_length(tax_id) <= 80),
...
-- MIGRACION 24: COBRO PARCIAL POR ITEMS
