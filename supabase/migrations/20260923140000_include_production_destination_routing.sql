...
-- migration-safety-reason: Extends the existing POS catalog routing payload so optimistic production entries are hidden when no physical destination is configured.
