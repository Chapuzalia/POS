  ...
  return (
    <div className="!grid !gap-4 xl:!grid-cols-2">
      <section className="min-w-0 overflow-hidden rounded-[var(--crm-radius-lg)] border-0 bg-[var(--crm-surface)] text-[var(--crm-text)] shadow-[var(--crm-shadow-card)] !overflow-hidden !rounded-2xl !bg-[var(--crm-surface)] !shadow-[var(--crm-shadow-card)]">
        <header className="!border-b !border-[var(--crm-border-subtle)] !p-5"><h2 className="!text-lg !font-bold">Categorías del local</h2><p className="!text-sm !text-[var(--crm-text-muted)]">Son globales y pueden aparecer en varias pestañas.</p><div className="!mt-4 !flex !gap-2"><UiInput className="h-11 min-h-11 w-full rounded-[var(--crm-radius-sm)] border border-transparent bg-[var(--crm-input-bg)] px-3.5 text-[13px] font-medium leading-[1.4] text-[var(--crm-text)] shadow-none outline-none transition-[border-color,box-shadow,background-color] duration-150 placeholder:text-[var(--crm-text-muted)] focus:border-[var(--crm-blue)] focus:shadow-[0_0_0_3px_var(--crm-blue-soft)] [&:is(textarea)]:h-auto [&:is(textarea)]:min-h-[88px] [&:is(textarea)]:resize-y [&:is(textarea)]:py-[11px] !min-w-0 !flex-1" onChange={(event) => setCategoryName(event.target.value)} placeholder="Nueva categoría" value={categoryName} /><UiButton className="inline-flex min-h-10 w-auto items-center justify-center gap-2 rounded-[var(--crm-radius-sm)] border-0 bg-[var(--crm-blue)] px-3.5 text-[13px] font-semibold leading-none text-white shadow-none transition-[background-color,color,box-shadow,transform] duration-150 hover:bg-[var(--crm-blue-hover)] hover:shadow-[0_8px_20px_rgba(20,120,237,0.22)]" disabled={disabled || !categoryName.trim()} onClick={() => void createCategory()} type="button"><Plus className="!size-4" /> Añadir</UiButton></div></header>
        <div className="!grid">
      ...
      <section className="min-w-0 overflow-hidden rounded-[var(--crm-radius-lg)] border-0 bg-[var(--crm-surface)] text-[var(--crm-text)] shadow-[var(--crm-shadow-card)] !overflow-hidden !rounded-2xl !bg-[var(--crm-surface)] !shadow-[var(--crm-shadow-card)]">
        <header className="!border-b !border-[var(--crm-border-subtle)] !p-5"><h2 className="!text-lg !font-bold">Pestañas del TPV</h2><p className="!text-sm !text-[var(--crm-text-muted)]">Organizan la navegación del TPV, no duplican categorías.</p><div className="!mt-4 !flex !gap-2"><UiInput className="h-11 min-h-11 w-full rounded-[var(--crm-radius-sm)] border border-transparent bg-[var(--crm-input-bg)] px-3.5 text-[13px] font-medium leading-[1.4] text-[var(--crm-text)] shadow-none outline-none transition-[border-color,box-shadow,background-color] duration-150 placeholder:text-[var(--crm-text-muted)] focus:border-[var(--crm-blue)] focus:shadow-[0_0_0_3px_var(--crm-blue-soft)] [&:is(textarea)]:h-auto [&:is(textarea)]:min-h-[88px] [&:is(textarea)]:resize-y [&:is(textarea)]:py-[11px] !min-w-0 !flex-1" onChange={(event) => setTabLabel(event.target.value)} placeholder="Nueva pestaña" value={tabLabel} /><UiButton className="inline-flex min-h-10 w-auto items-center justify-center gap-2 rounded-[var(--crm-radius-sm)] border-0 bg-[var(--crm-blue)] px-3.5 text-[13px] font-semibold leading-none text-white shadow-none transition-[background-color,color,box-shadow,transform] duration-150 hover:bg-[var(--crm-blue-hover)] hover:shadow-[0_8px_20px_rgba(20,120,237,0.22)]" disabled={disabled || !tabLabel.trim()} onClick={() => void createTab()} type="button"><Plus className="!size-4" /> Añadir</UiButton></div></header>
        <div className="!grid">
          {catalog.tabs.map((tab, index) => (
            <div className="!grid !grid-cols-[1fr_auto] !items-center !gap-3 !border-b !border-[var(--crm-border-subtle)] !p-4" key={tab.id}>
              ...
              <div className="flex min-w-0 items-center justify-end gap-[7px]">
                <UiButton aria-label="Subir pestaña" className="inline-flex size-9 min-h-9 min-w-9 items-center justify-center gap-2 rounded-[9px] border-0 bg-[var(--crm-surface-soft)] p-0 text-xs font-semibold text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)]" disabled={disabled || index === 0} onClick={() => void move('tabs', catalog.tabs, tab.id, -1)} type="button"><ArrowUp className="!size-4" /></UiButton>
                <UiButton aria-label="Bajar pestaña" className="inline-flex size-9 min-h-9 min-w-9 items-center justify-center gap-2 rounded-[9px] border-0 bg-[var(--crm-surface-soft)] p-0 text-xs font-semibold text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)]" disabled={disabled || index === catalog.tabs.length - 1} onClick={() => void move('tabs', catalog.tabs, tab.id, 1)} type="button"><ArrowDown className="!size-4" /></UiButton>
                <UiButton aria-label="Editar pestaña" className="inline-flex size-9 min-h-9 min-w-9 items-center justify-center gap-2 rounded-[9px] border-0 bg-[var(--crm-surface-soft)] p-0 text-xs font-semibold text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)]" disabled={disabled} onClick={() => openTabEditor(tab)} type="button"><Pencil className="!size-4" /></UiButton>
                <UiButton aria-label={tab.active ? 'Desactivar pestaña' : 'Activar pestaña'} className="inline-flex size-9 min-h-9 min-w-9 items-center justify-center gap-2 rounded-[9px] border-0 bg-[var(--crm-surface-soft)] p-0 text-xs font-semibold text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)]" disabled={disabled} onClick={() => void mutate(() => catalogAdminService.saveTab(catalog.venueId, { ...tab, active: !tab.active }))} type="button">{tab.active ? <EyeOff className="!size-4" /> : <Eye className="!size-4" />}</UiButton>
                <UiButton aria-label="Eliminar pestaña" className="inline-flex size-9 min-h-9 min-w-9 items-center justify-center gap-2 rounded-[9px] border-0 bg-[var(--crm-surface-soft)] p-0 text-xs font-semibold text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)] inline-flex min-h-10 w-auto items-center justify-center gap-2 rounded-[var(--crm-radius-sm)] border-0 bg-[var(--crm-red-soft)] px-3.5 text-[13px] font-semibold leading-none text-[var(--crm-red)] shadow-none transition-[background-color,color,box-shadow,transform] duration-150 hover:brightness-95" disabled={disabled} onClick={() => void removeTab(tab.id, tab.label)} type="button"><Trash2 className="!size-4" /></UiButton>
              </div>
            </div>
          ))}
        </div>
      ...
      {editingTabId ? <CrmModal label="Editar pestaña del TPV" onClose={() => setEditingTabId(null)} size="large">
        <form className="!flex !min-h-0 !flex-1 !flex-col" onSubmit={(event) => { event.preventDefault(); void saveEditedTab() }}>
          <div className="!grid !min-h-0 !gap-5 !overflow-y-auto !px-5 !py-5">
            <label className="!grid !gap-1.5"><span className="!text-[11px] !font-semibold !text-[var(--crm-text-secondary)]">Nombre</span><UiInput autoFocus className="h-11 min-h-11 w-full rounded-[var(--crm-radius-sm)] border border-transparent bg-[var(--crm-input-bg)] px-3.5 text-[13px] font-medium leading-[1.4] text-[var(--crm-text)] shadow-none outline-none transition-[border-color,box-shadow,background-color] duration-150 placeholder:text-[var(--crm-text-muted)] focus:border-[var(--crm-blue)] focus:shadow-[0_0_0_3px_var(--crm-blue-soft)] [&:is(textarea)]:h-auto [&:is(textarea)]:min-h-[88px] [&:is(textarea)]:resize-y [&:is(textarea)]:py-[11px] !h-11 !w-full" disabled={disabled} onChange={(event) => setEditingTabLabel(event.target.value)} value={editingTabLabel} /></label>
            <fieldset disabled={disabled}>
              <legend className="!mb-2 !text-[11px] !font-semibold !text-[var(--crm-text-secondary)]">Icono visible</legend>
              <UiInput aria-label="Buscar iconos" className="h-11 min-h-11 w-full rounded-[var(--crm-radius-sm)] border border-transparent bg-[var(--crm-input-bg)] px-3.5 text-[13px] font-medium leading-[1.4] text-[var(--crm-text)] shadow-none outline-none transition-[border-color,box-shadow,background-color] duration-150 placeholder:text-[var(--crm-text-muted)] focus:border-[var(--crm-blue)] focus:shadow-[0_0_0_3px_var(--crm-blue-soft)] [&:is(textarea)]:h-auto [&:is(textarea)]:min-h-[88px] [&:is(textarea)]:resize-y [&:is(textarea)]:py-[11px] !mb-3 !h-10 !w-full" onChange={(event) => setIconSearch(event.target.value)} placeholder="Buscar icono…" value={iconSearch} />
              {visibleIconOptions.length ? <div className="!grid !grid-cols-3 !gap-2 sm:!grid-cols-5 md:!grid-cols-6">
                {visibleIconOptions.map(({ Icon, key, label }) => <UiButton aria-label={`Usar icono ${label}`} aria-pressed={editingTabIcon === key} className={editingTabIcon === key ? '!grid !min-h-20 !place-items-center !gap-1.5 !rounded-[10px] !border !border-[var(--crm-blue)] !bg-[var(--crm-blue-soft)] !p-2 !text-xs !font-semibold !text-[var(--crm-blue)]' : '!grid !min-h-20 !place-items-center !gap-1.5 !rounded-[10px] !border !border-[var(--crm-border)] !bg-[var(--crm-surface-soft)] !p-2 !text-xs !font-semibold !text-[var(--crm-text-secondary)] hover:!border-[var(--crm-blue)]'} key={key} onClick={() => setEditingTabIcon(key)} type="button"><Icon className="!size-5" /><span>{label}</span></UiButton>)}
          ...
          <div className="!flex !justify-end !gap-2 !border-t !border-[var(--crm-border-subtle)] !px-5 !py-4"><UiButton className="inline-flex min-h-10 w-auto items-center justify-center gap-2 rounded-[var(--crm-radius-sm)] border-0 bg-[var(--crm-input-bg)] px-3.5 text-[13px] font-semibold leading-none text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,box-shadow,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)]" disabled={disabled} onClick={() => setEditingTabId(null)} type="button">Cancelar</UiButton><UiButton className="inline-flex min-h-10 w-auto items-center justify-center gap-2 rounded-[var(--crm-radius-sm)] border-0 bg-[var(--crm-blue)] px-3.5 text-[13px] font-semibold leading-none text-white shadow-none transition-[background-color,color,box-shadow,transform] duration-150 hover:bg-[var(--crm-blue-hover)] hover:shadow-[0_8px_20px_rgba(20,120,237,0.22)]" disabled={disabled || !editingTabLabel.trim()} type="submit">Guardar cambios</UiButton></div>
        </form>
      </CrmModal> : null}
      ...
      <section className="min-w-0 overflow-hidden rounded-[var(--crm-radius-lg)] border-0 bg-[var(--crm-surface)] text-[var(--crm-text)] shadow-[var(--crm-shadow-card)] !rounded-2xl !bg-[var(--crm-surface)] !p-5 !shadow-[var(--crm-shadow-card)] xl:!col-span-2">
        ...
        <div className="!mt-4 !grid !gap-2 md:!grid-cols-[1fr_1fr_auto]"><CrmSelect onChange={setAssociationTabId} options={catalog.tabs.map((tab) => ({ label: tab.label, value: tab.id }))} value={associationTabId} /><CrmSelect onChange={setAssociationCategoryId} options={catalog.categories.map((category) => ({ label: category.name, value: category.id }))} value={associationCategoryId} /><UiButton className="inline-flex min-h-10 w-auto items-center justify-center gap-2 rounded-[var(--crm-radius-sm)] border-0 bg-[var(--crm-blue)] px-3.5 text-[13px] font-semibold leading-none text-white shadow-none transition-[background-color,color,box-shadow,transform] duration-150 hover:bg-[var(--crm-blue-hover)] hover:shadow-[0_8px_20px_rgba(20,120,237,0.22)]" disabled={disabled || !associationTabId || !associationCategoryId} onClick={() => void mutate(() => catalogAdminService.saveTabCategory(catalog.venueId, { tabId: associationTabId, categoryId: associationCategoryId, active: true, sortOrder: catalog.tabCategories.filter((item) => item.tabId === associationTabId).length * 10 }))} type="button"><Link2 className="!size-4" /> Asociar</UiButton></div>
        <div className="!mt-4 !grid !gap-2">
          {catalog.tabs.map((tab) => {
            const associations = catalog.tabCategories.filter((item) => item.tabId === tab.id)
            return <div className="!rounded-xl !bg-[var(--crm-surface-soft)] !p-4" key={tab.id}><strong>{tab.label}</strong><div className="!mt-2 !grid !gap-2">{associations.map((association, index) => <div className="!flex !items-center !justify-between !gap-3" key={association.id}><span>{categoryById.get(association.categoryId)?.name ?? 'Categoría'} · {association.active ? 'Visible' : 'Oculta'}</span><div className="flex min-w-0 items-center justify-end gap-[7px]"><UiButton aria-label="Subir asociación" className="inline-flex size-9 min-h-9 min-w-9 items-center justify-center gap-2 rounded-[9px] border-0 bg-[var(--crm-surface-soft)] p-0 text-xs font-semibold text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)]" disabled={disabled || index === 0} onClick={() => void move('tab_categories', associations, association.id, -1)} type="button"><ArrowUp className="!size-4" /></UiButton><UiButton aria-label="Bajar asociación" className="inline-flex size-9 min-h-9 min-w-9 items-center justify-center gap-2 rounded-[9px] border-0 bg-[var(--crm-surface-soft)] p-0 text-xs font-semibold text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)]" disabled={disabled || index === associations.length - 1} onClick={() => void move('tab_categories', associations, association.id, 1)} type="button"><ArrowDown className="!size-4" /></UiButton><UiButton aria-label="Activar o desactivar asociación" className="inline-flex size-9 min-h-9 min-w-9 items-center justify-center gap-2 rounded-[9px] border-0 bg-[var(--crm-surface-soft)] p-0 text-xs font-semibold text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)]" disabled={disabled} onClick={() => void mutate(() => catalogAdminService.saveTabCategory(catalog.venueId, { ...association, active: !association.active }))} type="button">{association.active ? <EyeOff className="!size-4" /> : <Eye className="!size-4" />}</UiButton><UiButton aria-label="Eliminar asociación" className="inline-flex size-9 min-h-9 min-w-9 items-center justify-center gap-2 rounded-[9px] border-0 bg-[var(--crm-surface-soft)] p-0 text-xs font-semibold text-[var(--crm-text-secondary)] shadow-none transition-[background-color,color,transform] duration-150 hover:bg-[var(--crm-surface-hover)] hover:text-[var(--crm-text)] inline-flex min-h-10 w-auto items-center justify-center gap-2 rounded-[var(--crm-radius-sm)] border-0 bg-[var(--crm-red-soft)] px-3.5 text-[13px] font-semibold leading-none text-[var(--crm-red)] shadow-none transition-[background-color,color,box-shadow,transform] duration-150 hover:brightness-95" disabled={disabled} onClick={() => void mutate(() => catalogAdminService.deleteTabCategory(catalog.venueId, association.id))} type="button"><Trash2 className="!size-4" /></UiButton></div></div>)}</div></div>
          })}
        </div>
      </section>
    </div>
