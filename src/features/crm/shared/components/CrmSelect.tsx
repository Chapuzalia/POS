        ...
        >
          ...
          {visibleOptions.length ? (
            ...
            >
              {(option) => (
                <ListBoxItem
                  className="!relative !flex !min-h-10 !items-center !gap-3 !rounded-lg !bg-transparent !px-3 !py-2 !pr-10 !text-[13px] !leading-tight !text-[var(--crm-popover-text)] hover:!bg-[var(--crm-popover-hover)] data-[focused]:!bg-[var(--crm-popover-hover)] data-[hovered]:!bg-[var(--crm-popover-hover)] data-[selected]:!bg-[var(--crm-popover-selected)]"
                  id={option.value}
                ...
                >
                  ...
                  <ListBoxItem.Indicator className="!absolute !right-2.5 !top-1/2 !flex !size-5 !shrink-0 !-translate-y-1/2 !items-center !justify-center">
                    {({ isSelected }) =>
                      isSelected ? (
