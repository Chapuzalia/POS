...
export type CloseRestaurantOrderResult =
  | { requiresConfirmation: true; pendingUnits: number }
  | { requiresConfirmation: false; pendingUnits: number; orderId: string; ticketId: string; saleId: string; paymentId: string; totalCents: number }
