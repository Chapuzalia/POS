...
export type QuickSaleExistingTableSaveInput = { cashSessionId: string; deviceId: string; tableId: string; lines: TicketLine[]; discount: AppliedDiscount | null }
export type QuickSaleExistingTableSaveResult = { tableId: string; orderId: string; revision: number }
export type VirtualRestaurantTableDeleteInput = { cashSessionId: string; deviceId: string; tableId: string }
...
export type PosView = { type: 'table_map'; areaId?: string } | { type: 'table_order'; orderId: string } | { type: 'quick_sale'; areaId?: string }
